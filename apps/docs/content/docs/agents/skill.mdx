...
<Tabs items={["skills.sh", "Manuel"]}>
  ...
  <Tab value="Manuel">
    ...
    curl -o ~/.claude/skills/tiime.md \
      https://raw.githubusercontent.com/yabbal/tiime-cli/main/SKILL.md
    ```
  </Tab>
</Tabs>
...
---
name: tiime
description: CLI pour interagir avec l'application de comptabilite Tiime
---
```
...
| Catégorie | Mots-clés |
|-----------|-----------|
| Général | `tiime`, `comptabilite`, `compta` |
