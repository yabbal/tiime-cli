...
const descriptionTranslations: Record<string, string> = {
	...
	"Lister les fournisseurs": "List suppliers",
	"Détails d'un fournisseur": "Supplier details",
	"Rechercher un fournisseur": "Search for a supplier",
